...
void menu::TouchdrawBox() {
    ...
    if (global::load) {
        ...
        if (showgui && ImGui::Begin("Added tools by Sahyui#1337", &showgui, ImGuiWindowFlags_NoCollapse)) {
            animate();
            static char* tab_names[] = { (char*)"Enhancements", (char*)"Cheats", (char*)"Framework", (char*)"Player", (char*)"Others" };
        ...
        loopRainbow();
        auto draw = ImGui::GetBackgroundDrawList();
        std::string hah = "Added tools by Sahyui#1337";

...
namespace opt {
	...
	std::string	gt_supported    = "4.20";	//the gt version for which INZERNAL was built for. Probably wont work for other versions.
	...
	std::string	flag		= "az";		//set if flag_mode is set to fmCustom
